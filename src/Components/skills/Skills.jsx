import "./skills.css";
import { FaHtml5, FaCss3, FaUniversalAccess } from "react-icons/fa";
import { SiJavascript, SiReact, SiMysql, SiPostman } from "react-icons/si";
    ...
    <section id="skills" className="skills__section container">
      ...
      <article className="skills__container">
        <ul className="skills">
          ...
          <li>
            <SiPostman className="skill__icon_small" />
            <p>Postman</p>
          </li>
        </ul>
      </article>
